...
var Navbar = () => {
  return /*#__PURE__*/React.createElement("div", null, "Witaj na stonie");
};
...
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || es_unsupportedIterableToArray(arr) || _nonIterableSpread(); }

function _nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }

function _iterableToArray(iter) { if (typeof Symbol !== "undefined" && Symbol.iterator in Object(iter)) return Array.from(iter); }

function _arrayWithoutHoles(arr) { if (Array.isArray(arr)) return es_arrayLikeToArray(arr); }
...
function es_iterableToArrayLimit(arr, i) { if (typeof Symbol === "undefined" || !(Symbol.iterator in Object(arr))) return; var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }
...
// EXTERNAL MODULE: ./node_modules/react-csv-reader/dist/react-csv-reader.js
var react_csv_reader = __webpack_require__(504);
;// CONCATENATED MODULE: ./src/components/Home/Home.module.scss
// extracted by mini-css-extract-plugin
/* harmony default export */ const Home_module = ({"Home":"Home","Home__file":"Home__file"});
...
var Home = () => {
  ...
  var [ChurchWeddingInfo, setChurchWeddingInfo] = (0,react.useState)({
  ...
  var [PartyWeddingInfo, setPartyWeddingInfo] = (0,react.useState)({
    StartDate: "2021-03-18T14:17",
    Location: {
      Latitude: "21.1",
      Longitude: "20.2"
  ...
  var [guests, setGuests] = (0,react.useState)(null);

  var handleOnSubmit = e => {
    e.preventDefault();

    var result = Home_objectSpread(Home_objectSpread({}, info), {}, {
      ChurchWeddingInfo: Home_objectSpread({}, ChurchWeddingInfo),
      PartyWeddingInfo: Home_objectSpread({}, PartyWeddingInfo)
    });

    var formData = new FormData();
    formData.append("wedding", JSON.stringify(result));
    formData.append("guestsFile", guests);
    var config = {
      headers: {
    ...
    axios_default().post("https://weddingonline-test.azurewebsites.net/api/ucantguessit", formData, config).then(response => {
  ...
  var onInputChange = event => {
    ...
    setInfo(Home_objectSpread(Home_objectSpread({}, info), {}, {
      [name]: value
    }));
  };

  var onInputChangeChurchWeddingInfo = event => {
    var {
      name,
      value
    } = event.target;
    setChurchWeddingInfo(Home_objectSpread(Home_objectSpread({}, ChurchWeddingInfo), {}, {
      [name]: value
    }));
  };

  var onInputChangePartyWeddingInfo = event => {
    var {
      name,
      value
    } = event.target;
    setPartyWeddingInfo(Home_objectSpread(Home_objectSpread({}, PartyWeddingInfo), {}, {
      [name]: value
    }));
  };
  ...
  }), /*#__PURE__*/react.createElement("button", null, "Wyslij")));
};
...
var App = () => {
  ...
  return isMobile ? /*#__PURE__*/react.createElement("div", {
    ...
    path: "/",
    exact: true,
    render: () => /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(Home_Home, null))
  })))));
};
